...
class LoginScreenRestaurant extends StatefulWidget {
  @override
  _LoginScreenRestaurantState createState() => _LoginScreenRestaurantState();
}

class _LoginScreenRestaurantState extends State<LoginScreenRestaurant> {
